...
namespace MWWorld
{
    ...
    public:
        ...
        // Load path: seed counts + key flags, mark done so validateRecords
        // skips the scan. Save path: extract for serialization.
        ...
        // RefId -> sole containing cell, for ids that live in exactly one
        // cell (ambiguous ids are omitted; lookups fall back to the sweep).
