...
namespace MWWorld
{
    ...
    private:
        ...
        // Ring cells awaiting their shell prepare (heightfield/water/
        // pathgrid); one per healthy frame, then they join mPendingCellLoads.
        std::vector<CellStore*> mPendingPrepares;
        void processPendingPrepares(float duration);
